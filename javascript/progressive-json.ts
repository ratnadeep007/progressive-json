...
export class ProgressiveJSON {
  private result: ProgressiveJSONResult | any[] | null = null;
  ...
  private parseList(data: any[], chunkNumber?: number): void {
    if (!chunkNumber) {
  ...
  private replacePlaceholders(targetDict: ProgressiveJSONResult, chunkData: any, chunkNumber: number): void {
  ...
  private replacePlaceholdersInList(targetList: any[], chunkData: any, chunkNumber: number): void {
